...
// and the touchscreen -/+ still step by 1); see IntervalSelectionActivity's
// own front/side split for the same convention elsewhere.
...
void CompanionSleepTimeActivity::drawStepHintLine(const int y, const StrId labelId, const int step) const {
  char line[32];
